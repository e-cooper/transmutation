...
SOURCES            = main.c myLib.c sound.c game.c sprites.c gb_images/mainmap.c gb_images/collisionmainmap.c gb_images/instructionScreen.c gb_images/pauseScreen.c gb_images/startScreen.c gb_images/winScreen.c gb_images/loseScreen.c gb_images/sprites.c gb_sounds/CollectionJingle.c gb_sounds/MainSoundtrack.c gb_sounds/HurtSound.c
